...
class User extends Model {
    ...
    public static function getForgot($email, $inadmin = true)
    {
        ...
        if (count($results) === 0)
        {
            ...
            $results2 = $sql->select("CALL sp_userspasswordsrecoveries_create(:id, :desip)", array(
                ":iduser" => $data["iduser"],
            ...
            if (count($results2) ===0)
            {
                ...
                if($inadmin === true){
                    ...
                    $link = "http://localhos:8000/forgot/reset?code=$code";
                }
    ...
    public static function validForgotDecrypt($code)
    {
        ...
        $idrecovery = mcypt_descrypt(MCRYPT_RIJNDAEL_128, User::SECRET, base64_decode($code), MCRYPT_MODE_ECB);
